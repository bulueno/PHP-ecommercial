			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						...
						<li class="fmobile"><?php echo $ayarcek['ayar_gsm']; ?><br><?php echo $ayarcek['ayar_tel']; ?><?php echo $ayarcek['ayar_gsm']; ?></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy; <?php echo $ayarcek['ayar_author']; ?> <a href="http://www.wowmarketplace.com">www.wowmarketplace.com</a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href="http://<?php echo $ayarcek['ayar_youtube']; ?>" class="ffacebook">Youtube</a>
